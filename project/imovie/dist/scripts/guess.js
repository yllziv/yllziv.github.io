...
function showMovies() { //初始化15部电影，文字，图片，未选中的心心
  ...
  for (var i = 0; i < movieblocks.length; i++) {
    ...
    $(movieblocks[i]).append("<a class='heartclick'><img class='unlove' src='../images/iconfont-unlove.png' width='30'/></a>");
  }
}
...
function heartClick() {
  ...
  if (img.className == "unlove") {
    $(img).removeClass();
    img.className = "loved";
    img.src = "../images/iconfont-love.png";
  } else {
    $(img).removeClass();
    img.className = "unlove";
    img.src = "../images/iconfont-unlove.png";
  }
