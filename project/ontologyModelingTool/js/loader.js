...
(function() {
  ...
  if (!raw) {
    document.write('<scr' + 'ipt type="text/javascript" src="js/ol.js"></scr' + 'ipt>');
  } else {
    window.CLOSURE_NO_DEPS = true; // we've got our own deps file
    document.write('<scr' + 'ipt type="text/javascript" src="js/base.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="js/ol-deps.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="js/select-features-require.js"></scr' + 'ipt>');
  }
  document.write('<scr' + 'ipt type="text/javascript" src="js/select-features.js"></scr' + 'ipt>');
}());
